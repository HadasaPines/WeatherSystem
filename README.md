...
The system consists of three main components running in separate Docker containers:
...
You don't need to install Python or any dependencies locally. Docker will handle everything for you.

1. Clone this repository to your local machine:
   ```bash
   git clone https://github.com/HadasaPines/WeatherSystem.git
   cd WeatherSystem
   ```
...
3. Wait a few seconds for the application to start completely. You will see logs indicating that the Uvicorn servers and RabbitMQ are running. The Consumer is configured to wait and retry connecting until RabbitMQ is fully ready.
...
Once the containers are up, you can interact with the system using the automatically generated Swagger UI:

### 1. Request Weather (Producer)
...
### 2. Get Results (Consumer/Result API)
